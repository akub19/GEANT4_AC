...
G4VPhysicalVolume* GeometryConstruction::Construct()
{
  ...
  G4VSolid* veto1 = new G4Box("Veto1", 35.*mm, 5*mm, detHalfZ);
  G4VSolid* veto2 = new G4Box("Veto2", 35.*mm, 5*mm, detHalfZ);
  G4VSolid* veto3 = new G4Box("Veto3", 35.*mm, 5*mm, detHalfZ);
  G4VSolid* veto4 = new G4Box("Veto4", 35.*mm, 5*mm, detHalfZ);
  G4VSolid* veto5 = new G4Box("Veto5", 35.*mm, 5*mm, detHalfZ);
  G4VSolid* veto6 = new G4Box("Veto6", 35.*mm, 5*mm, detHalfZ);
  ...
  new G4PVPlacement(yRot4,zTrans4,fLogicVeto4,"Veto4_phys",universe_log,false,0,fCheckOverlaps);
